...
@section('content')
    <div class="content-wrapper">
                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">Appliances</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="content-header-right col-md-6 col-12 mb-2">
                <a href="#" data-toggle="modal"data-target="#addAppliance" class="btn btn-primary float-md-right">ADD</a>
            </div>
        </div>
                                                            ...
                                                            <td>
                                                                @if($data->is_active == 1)
                                                                    ...
                                                                    <button type="button" class="btn btn-icon btn-outline-danger btn-sm" title="Inactive" 
                                                                        onclick="deleteData('{{ route('appliance.delete', [$data->id]) }}')">
                                                                        <i class="fa fa-trash" aria-hidden="true"></i>
                                                                    </button>
                                                                @else
                                                                    <button type="button" class="btn btn-icon btn-outline-primary btn-sm" title="Restore" 
                                                                        onclick="restoreData('{{ route('appliance.restore', [$data->id]) }}')">
        ...
        <!-- Start Add Modal -->
        <div class="modal fade text-left" id="addAppliance" tabindex="-1" role="dialog" 
            aria-labelledby="myModalLabel35" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="myModalLabel35">Add Appliance Form</h3>
        ...
        <!-- Start Add Modal -->
        <div class="modal fade text-left" id="editAppliance" tabindex="-1" role="dialog" 
            aria-labelledby="myModalLabel35" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="myModalLabel35">Edit Appliance Form</h3>
                        <button type="button" class="close text-danger" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="{{ route ('appliance.update')}}" method="post"  class="clearForm form" 
                        enctype="multipart/form-data">@csrf
                        <div class="modal-body">
...
@section('script')
    <script type="text/javascript">
        ...
        $("#editAppliance").on("hide.bs.modal", function (e) {
            location.reload();
        });
    </script>
@endsection